...
from run import run
from utility import pickle_dump, load_words, distance_function
...
class WordSpellingCorrection:
    ...
    def get_candidate_words(self, word, max_edit_distance = 3):
        ...
        """
        return [i[1] for x in run(word, self.filepath_bk_tree, max_edit_distance = max_edit_distance) for i in x]
...
spellCorr = WordSpellingCorrection('wiki.train.tokens', 'eng_tree_10K.pkl', 'token_cnts_wiki.json', vocab)
print(spellCorr.spelling_correction("You hut is beautiful", 2) )